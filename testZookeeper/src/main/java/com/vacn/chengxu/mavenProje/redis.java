...
public class redis {
   ...
   /*public static void main(String[] args) {
	   ...
	   Books1 book1=new Books1();
	    try {
			PropertyUtils.copyProperties(book1, book);
	...
	public static void main(String[] args) {
		pool = new JedisPool(new JedisPoolConfig(), "192.168.3.247",6379,20000) {
		};  
   ...
   @Before 
   public void setUp() { 
   pool = new JedisPool(new JedisPoolConfig(), "192.168.2.96",6379,20000,"123");  
   jedis = pool.getResource();
   System.out.println(jedis.get("lu"));
   //   jedis.auth("password"); 
   } 
   ...
   */ 
   ...
   public void testMap(){ 
	   ...
	   System.out.println("rsmap的值"+rsmap);  
	   for(String value:rsmap){
